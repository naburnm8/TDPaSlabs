...
if __name__ == '__main__':
    ...
    task_memory = None
    n_tasks = sum(q_tasks)
    print("Текущие параметры генератора случайных задач:\nТип: CYCLE_TASK, диапазон тактов: 1 - 60, TTL: 50\nТип: PERIODIC_TASK, диапазон тактов: 1 - 100, TTL: 95\nТип: IMPULSE_TASK, диапазон тактов: 1 - 20, TTL: 10")
